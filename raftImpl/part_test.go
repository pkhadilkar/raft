...
func TestPartition(t *testing.T) {
	raftConf := &RaftConfig{MemberRegSocket: "127.0.0.1:8124", PeerSocket: "127.0.0.1:9987", TimeoutInMillis: 1500, HbTimeoutInMillis: 150, LogDirectoryPath: "logs", StableStoreDirectoryPath: "./stable1", RaftLogDirectoryPath: "../LocalLog1"}
	...
	for i := 1; i <= serverCount; i += 1 {
		...
		clusterServer, err := cluster.NewWithConfig(i, "127.0.0.1", 7129+i, RaftToClusterConf(raftConf))
